 ...
 <form action="<?php echo $action ;?>" method="post" class="navbar-form navbar-left" role="search">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="<?php echo base_url();?>index.php/c_barang/update/<?php echo $row->kode_barang;?>" class="btn btn-info btn-sm">
            <i class="glyphicon glyphicon-pencil"></i></a>
          <a href="<?php echo base_url();?>index.php/c_barang/det/<?php echo $row->kode_barang;?>" class="btn btn-warning btn-sm">
            <i class="glyphicon glyphicon-search"></i></a>
            <a href="<?php echo base_url();?>index.php/c_barang/hapus/<?php echo $row->kode_barang;?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda Yakin menghapus data ini?')">
